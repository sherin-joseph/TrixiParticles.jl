...
# Output prefixes 
out_prefix_newton = "out_bubble_newton2"
out_prefix_cy     = "out_bubble_carreau_yasuda2"

# Bubble placement
bubble_center = (0.5Lx, 0.35Ly)
bubble_radius = 0.15Lx
...
function build_simulation(; viscosity_liquid, viscosity_gas, output_prefix::String)
    ...
    dd = DensityDiffusionMolteniColagrossi(delta=0.03)
    ...
    stepsize_cb = StepsizeCallback(cfl=0.2)
